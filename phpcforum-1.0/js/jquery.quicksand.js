        ...
        return this.each(function (i) {
            ...
            if ($correctionParent.css('position') == 'relative') {
                if ($correctionParent.get(0).nodeName.toLowerCase() == 'body') {
                   ...
                   /* correctionOffset.top += parseFloat($correctionParent.css('border-top'));
                    correctionOffset.left += parseFloat($correctionParent.css('border-left'));*/
                }
            } else {
                /*correctionOffset.top -= parseFloat($correctionParent.css('border-top'));
                correctionOffset.left -= parseFloat($correctionParent.css('border-left'));*/
            ...
            for (i = 0; i < animationQueue.length; i++) {
                animationQueue[i].element.animate(animationQueue[i].animation, options.duration, options.easing, animationPMIsFinish(i, animationQueue.length));
            }
